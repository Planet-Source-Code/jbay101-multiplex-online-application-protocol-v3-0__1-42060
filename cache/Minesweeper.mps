...
Set frmMain_draw = CForm.CreateDrawingObject(frmMainID)
...
Sub DoAllBorders()
    '-Outermost border
    DrawBorder frmMain_draw, 3, 3, frmMain_draw.ScaleWidth - 7, _
        frmMain_draw.ScaleHeight - 7, 3, vbWhite, vbButtonShadow
    '-Upper
    DrawBorder frmMain_draw, 11, 11, frmMain_draw.ScaleWidth - 25, 32, 2, vbButtonShadow, vbWhite
    '-Lower
    DrawBorder frmMain_draw, 12, 55, frmMain_draw.ScaleWidth - 27 _
        , frmMain_draw.ScaleHeight - 68, 3, vbButtonShadow, vbWhite
    '-Flags
    DrawBorder frmMain_draw, picFlags.Left, picFlags.Top, picFlags.Width, _
        picFlags.Height - 1, 1, vbButtonShadow, vbWhite
    '-NewButton
    DrawBorder frmMain_draw, optNewGame.Left, optNewGame.Top, 22, _
        22, 1, vbButtonShadow, DARKSHADOW
    '-TifrmMainCount
    DrawBorder frmMain_draw, picTimeCount.Left, picTimeCount.Top, picTimeCount.Width, _
...
'    mnuMarks.Checked = OnQMark
	...
	frmMain.SetFlag "maxbutton", False
	frmMain.SetFlag "minbutton", False
