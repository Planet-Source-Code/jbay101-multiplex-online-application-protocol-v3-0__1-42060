...
Public Sub RegisterType()
  ...
  fileEx = ".mps"
  Discription = "MultiPlex Script"

  CreateNewKey fileEx, HKEY_CLASSES_ROOT
  SetKeyValue fileEx, "", Discription, REG_SZ
  CreateNewKey Discription & "\shell\Open\command", HKEY_CLASSES_ROOT
  CreateNewKey Discription & "\shell\Edit\command", HKEY_CLASSES_ROOT
  CreateNewKey Discription & "\shell\Print\command", HKEY_CLASSES_ROOT
  
  CreateNewKey Discription & "\DefaultIcon", HKEY_CLASSES_ROOT
  
  SetKeyValue Discription & "\DefaultIcon", "", App.path & "\" & App.EXEName & ".exe,1", REG_SZ
  SetKeyValue Discription, "", "MultiPlex script file", REG_SZ
  sPath = App.path & "\" & App.EXEName & ".exe %1"
  'MsgBox sPath
  SetKeyValue Discription & "\shell\Open", "", "&Execute", REG_SZ
  SetKeyValue Discription & "\shell\Edit", "", "&Edit", REG_SZ
  SetKeyValue Discription & "\shell\Print", "", "&Print", REG_SZ
  
  
  SetKeyValue Discription & "\shell\Open\command", "", sPath, REG_SZ
  SetKeyValue Discription & "\shell\Edit\command", "", "C:\WINDOWS\Notepad.exe %1", REG_SZ
  SetKeyValue Discription & "\shell\Print\command", "", "C:\WINDOWS\Notepad.exe /p %1", REG_SZ
